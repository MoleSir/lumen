...
class Tensor:
    ...
    def add_(self, other: TensorOrScaler) -> None: ...
    def sub_(self, other: TensorOrScaler) -> None: ...
    def mul_(self, other: TensorOrScaler) -> None: ...
    def div_(self, other: TensorOrScaler) -> None: ...
