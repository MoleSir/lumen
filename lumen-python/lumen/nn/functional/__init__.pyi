...
def embeddding(weight: Tensor, indexes: Tensor) -> Tensor: ...
...
def nll_loss(input: Tensor, target: Tensor, reduction="mean") -> Tensor: ...

def cross_entropy(input: Tensor, target: Tensor, reduction="mean") -> Tensor: ...

def soft_cross_entropy(input: Tensor, target: Tensor, reduction="mean") -> Tensor: ...
